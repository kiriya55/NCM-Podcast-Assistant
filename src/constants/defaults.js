export const DEFAULT_NAME_TEMPLATE = '【{projectName}】{songTitle} - {artistName}'
export const DEFAULT_INTRO_TEMPLATE = `原名：{originalTitle}
作词：{lyricist}
作曲：{composer}
编曲：{arranger}
歌：{artistName}`

export const DEFAULT_SYSTEM_PROMPT = `你是一个音乐信息提取助手。用户会给你一段关于歌曲的自然语言描述，你需要从中提取结构化信息。
